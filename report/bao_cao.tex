...
\subsection*{Chia tập Pool (Train) / Test}

Tập Test là một \textbf{bộ dữ liệu hoàn toàn mới}, thu thập ở giai đoạn sau đó — mô phỏng sát tình huống triển khai thực tế, khi mô hình phải dự báo cho dữ liệu chưa từng "nhìn thấy" trong suốt quá trình phát triển. Phần dữ liệu còn lại — gọi là \textbf{Pool} — được dùng chung cho cả huấn luyện lẫn đánh giá nội bộ bằng sliding-fold cross-validation (Mục~2.4.2):

\begin{table}[H]
\centering
\caption{Phân chia Pool / Test (dữ liệu theo ngày)}
\begin{tabular}{lrll}
\toprule
Tập & Số ngày & Từ & Đến \\
\midrule
Pool & 1.453 & 2022-08-04 & 2026-07-26 \\
...
Vì Pool được dùng chung cho cả huấn luyện lẫn đánh giá, một cơ chế \textbf{sliding-fold cross-validation} được áp dụng: Pool được quét bằng nhiều fold $(X, y)$ liên tiếp, mỗi fold gồm 28 ngày làm đầu vào và 7 ngày kế tiếp làm mục tiêu, dịch đi đúng 7 ngày (bằng horizon) sau mỗi fold để phần mục tiêu giữa các fold không chồng lấn — thu được \textbf{203 fold} trên toàn bộ Pool. Validation loss (MAE, thang chuẩn hóa) dùng cho Grid Search và early-stopping được tính trung bình trên toàn bộ 203 fold này, thay vì dựa trên một khối dữ liệu cố định duy nhất — giúp tín hiệu đánh giá ổn định và đáng tin cậy hơn đáng kể.
...
\begin{table}[H]
\centering
\caption{Kết quả Grid Search siêu tham số (val\_loss trung bình trên 203 fold, sắp xếp tăng dần)}
\begin{tabular}{rrr}
\toprule
...
Cấu hình được chọn là cấu hình có validation loss thấp nhất: \texttt{hidden\_size}$=64$, \texttt{learning\_rate}$=0.0005$.
...
Quá trình huấn luyện chạy hết ngân sách 40 epoch mà không kích hoạt early stopping, đạt validation loss tốt nhất $\approx 0.0848$ (thang chuẩn hóa) tại epoch 39 (Hình~\ref{fig:hybrid_learning_curve}). Nhờ được tính trung bình trên 203 fold, đường Validation Loss giảm khá mượt và bám sát xu hướng của Train Loss trong suốt quá trình huấn luyện.
...
\midrule
1 & 2026-07-27 -- 2026-08-02 & 2.975 & 3.636 \\
2 & 2026-08-03 -- 2026-08-09 & 4.379 & 5.158 \\
3 & 2026-08-10 -- 2026-08-16 & 2.232 & 2.580 \\
4 & 2026-08-17 -- 2026-08-23 & 2.306 & 2.574 \\
\midrule
\textbf{Tổng hợp (28 ngày)} & & \textbf{2.973} & \textbf{3.644} \\
\bottomrule
\end{tabular}
\end{table}
